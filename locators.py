...
class Locators:
    SEARCH_ACCOUNT_BUTTON = By.XPATH, "//a[@href='/account']"  # кнопка Личный кабинет
    SEARCH_REGISTER_REFERENCE = By.XPATH, "//a[@href='/register']"  # ссылка Регистрация на странице входа в ЛК
